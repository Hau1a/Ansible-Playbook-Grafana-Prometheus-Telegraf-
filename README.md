...
3. download the Grafana rpm archive from the official website in advance and specify its location in grafana.yml
4. execute a series of commands inside the ansyble-telegraf directory: 
